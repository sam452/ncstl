    ...
    <div id='footer'>
      <footer class="clearfix">
        <div class="bLogo"><img src="<?php echo get_template_directory_uri(); ?>/img/logo.jpg" width="128" height="72" alt="NCStL logo" /><span class="typemin">
        ...
        <div class="footerLinks">
          <ul>
            ...
            <li>
            <a class="footerLinkText" href="/ncstl/history/">History / Memorabilia</a>
            </li>
            <li>
            <a class="footerLinkText" href="/ncstl/locomotives/">Locomotives / Equipment</a>
            </li>
            <li>
            <a class="footerLinkText" href="/ncstl/merchandise/">Merchandise</a>
            </li>
          </ul>
        ...
        <div class="footerLinks">
          <ul>
            ...
            <li>
            <a class="footerLinkText" href="/ncstl/events/">Events</a>
            </li>
            <li>
