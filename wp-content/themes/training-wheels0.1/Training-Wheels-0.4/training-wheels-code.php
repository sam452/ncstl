...
<!-- Register Numbered Sidebar -->
<?php
  if ( function_exists('register_sidebars') )
	register_sidebars(2);
?>

<!-- PLACING NUMBERED SIDEBARS -->

<!-- simplest form -->
<?php dynamic_sidebar(1); ?>

<!-- Including Default Widget -->
...
<!-- Register Named Sidebar-->
<?php if (function_exists('register_sidebar')) 
	register_sidebar('Left Side');
?>


<!-- Register Multiple Customised Named Sidebars -->
<?php if (function_exists('register_sidebar')) 
...
<!-- Register Multiple Named Sidebars -->
<?php if (function_exists('register_sidebar')) 
...
<!-- Place Named Sidebar Simplest form -->
<?php dynamic_sidebar('Left Side'); ?>



<!-- Place Named Sidebar with default HTML Content -->
...
<!-- Place Named Sidebar with default Hard-Coded Widgets -->
